...
void FileSelector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (FileSelector::*)(const QString & )>(_a, &FileSelector::fileSelected, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (FileSelector::*)(const QString & )>(_a, &FileSelector::fileSaved, 1))
            return;
    }
}
...
// SIGNAL 0
void FileSelector::fileSelected(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void FileSelector::fileSaved(const QString & _t1)
{
